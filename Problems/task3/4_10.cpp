...
struct Has<T, Deque<U, Us...>>
{
    static constexpr bool value =
        std::is_same_v<T, U> || Has<T, Deque<Us...>>::value;
};
...
int main()
{
    ...
    static_assert(!has_v<int, Deque<>>);
    static_assert(has_v<int, Deque<int>>);
    static_assert(!has_v<double, Deque<int>>);

    static_assert(has_v<double, Deque<int, double, char>>);
    static_assert(has_v<char, Deque<int, double, char>>);
    static_assert(!has_v<float, Deque<int, double, char>>);
}
